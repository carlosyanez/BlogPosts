...
lockdown_areas <- postcode %>% filter(POA_CODE16 %in% confined_melbourne)
...
map<- leaflet(option=leafletOptions(zoomControl=TRUE)) %>%
  ...
  addProviderTiles("OpenStreetMap.Mapnik") %>%
    addPolygons(data=lockdown,stroke = TRUE, smoothFactor = 0.3, fillOpacity = 0.8,fillColor="#ff8a00",
                color="black",opacity = 0.8,weight = 0.8,
              label=~Suburb) 
