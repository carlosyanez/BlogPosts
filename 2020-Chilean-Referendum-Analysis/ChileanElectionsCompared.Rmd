...
#%>%
#       formatRound(`Participación 2020`, 1) %>%
#       formatRound(`Porcentaje Apruebo`, 1) %>%
#       formatRound(`Participación 2017`,1)


chart_a <- list(
HTML("<h1> Comparación de Participación entre Diputados 2017 y Plebiscito 2020 </h1>"),
bscols(
