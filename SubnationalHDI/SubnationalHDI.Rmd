...
render_maps <- FALSE
#image_address <- "https://www.carlosyanez.cl/wp-content/uploads/2020/07/"
image_address <-"./"
#map_address <- "https://www.carlosyanez.cl/wp-content/uploads/2020/07/"
map_address <-"./"
...
Probably, this map conforms with a *traditional* view of the world: on one side we have *highly developed*, *industralised* economies.  African countries are situated on the other extreme of development, with Latin American and Asian countries covering the range in the middle.
...
3. Data comes from the [World Income Inequality Database](https://www.wider.unu.edu/project/wiid-world-income-inequality-database). 
...
7. R  Notebook file available [here](https://github.com/carlosyanez/BlogPosts/blob/master/SubnationalHDI/SubnationalHDI.Rmd)
